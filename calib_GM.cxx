...
*/
	...
	Chain1->Add("/media/harry/GODDESS_ANA1/84Se/cal1/alpha_cal_E_1.root"); //All SX3 calibration
   ...
   SX3_prots_down->SetPoint(13,0.859417,10.4571);
	...
	TFile write("fine_cal_hists_UU_res_strips.root", "recreate");
			...
			for( int j=0;j<E_front_cont_UpB.size();j++)
			{
				for( int h=j;h<E_front_cont_UpB.size();h++)
				{
					...
					if(E_front_cont_UpB.at(j)==1 && E_front_cont_UpB.at(h)==2)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==2) calib_Det2_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==3) calib_Det3_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==4) calib_Det4_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==5) calib_Det5_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==6) calib_Det6_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==7) calib_Det7_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==8) calib_Det8_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==9) calib_Det9_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==10) calib_Det10_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==11) calib_Det11_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==12) calib_Det12_Strip1->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));	
					...
					if(E_front_cont_UpB.at(j)==2 && E_front_cont_UpB.at(h)==1)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==2) calib_Det2_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==3) calib_Det3_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==4) calib_Det4_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==5) calib_Det5_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==6) calib_Det6_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==7) calib_Det7_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==8) calib_Det8_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==9) calib_Det9_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==10) calib_Det10_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==11) calib_Det11_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==12) calib_Det12_Strip1->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
					...
					if(E_front_cont_UpB.at(j)==3 && E_front_cont_UpB.at(h)==4)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==2) calib_Det2_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==3) calib_Det3_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==4) calib_Det4_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==5) calib_Det5_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==6) calib_Det6_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==7) calib_Det7_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==8) calib_Det8_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==9) calib_Det9_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==10) calib_Det10_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==11) calib_Det11_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==12) calib_Det12_Strip2->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
					...
					if(E_front_cont_UpB.at(j)==4 && E_front_cont_UpB.at(h)==3)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==2) calib_Det2_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==3) calib_Det3_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==4) calib_Det4_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==5) calib_Det5_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==6) calib_Det6_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==7) calib_Det7_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==8) calib_Det8_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==9) calib_Det9_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==10) calib_Det10_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==11) calib_Det11_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==12) calib_Det12_Strip2->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
					...
					if(E_front_cont_UpB.at(j)==6 && E_front_cont_UpB.at(h)==5)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==2) calib_Det2_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==3) calib_Det3_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==4) calib_Det4_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==5) calib_Det5_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==6) calib_Det6_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==7) calib_Det7_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==8) calib_Det8_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==9) calib_Det9_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==10) calib_Det10_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==11) calib_Det11_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==12) calib_Det12_Strip3->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
					...
					if(E_front_cont_UpB.at(j)==5 && E_front_cont_UpB.at(h)==6)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==2) calib_Det2_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==3) calib_Det3_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==4) calib_Det4_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==5) calib_Det5_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==6) calib_Det6_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==7) calib_Det7_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==8) calib_Det8_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==9) calib_Det9_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==10) calib_Det10_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==11) calib_Det11_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==12) calib_Det12_Strip3->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
					...
					if(E_front_cont_UpB.at(j)==8 && E_front_cont_UpB.at(h)==7)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==2) calib_Det2_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==3) calib_Det3_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==4) calib_Det4_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==5) calib_Det5_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==6) calib_Det6_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==7) calib_Det7_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==8) calib_Det8_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==9) calib_Det9_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==10) calib_Det10_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==11) calib_Det11_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
						if(detID_UpB==12) calib_Det12_Strip4->Fill(E_front_en_UpB.at(j),E_front_en_UpB.at(h));
					...
					if(E_front_cont_UpB.at(j)==7 && E_front_cont_UpB.at(h)==8)
					{
						...
						if(detID_UpB==1) calib_Det1_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==2) calib_Det2_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==3) calib_Det3_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==4) calib_Det4_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==5) calib_Det5_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==6) calib_Det6_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==7) calib_Det7_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==8) calib_Det8_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==9) calib_Det9_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==10) calib_Det10_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==11) calib_Det11_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
						if(detID_UpB==12) calib_Det12_Strip4->Fill(E_front_en_UpB.at(h),E_front_en_UpB.at(j));
