...
void calib_sx3_2nd_step()
{
	...
	ifstream SX3_calib_params ("SX3_UD_final_energy_cal_params.txt");
...
*/
	...
	TH1D* D1S1 = new TH1D("D1S1","D1S1",1000,1000,3000);
	TH1D* D1S2 = new TH1D("D1S2","D1S2",1000,1000,3000);
	TH1D* D1S3 = new TH1D("D1S3","D1S3",1000,1000,3000);
	TH1D* D1S4 = new TH1D("D1S4","D1S4",1000,1000,3000);

	TH1D* D2S1 = new TH1D("D2S1","D2S1",1000,1000,3000);
	TH1D* D2S2 = new TH1D("D2S2","D2S2",1000,1000,3000);
	TH1D* D2S3 = new TH1D("D2S3","D2S3",1000,1000,3000);
	TH1D* D2S4 = new TH1D("D2S4","D2S4",1000,1000,3000);

	TH1D* D3S1 = new TH1D("D3S1","D3S1",1000,1000,300);
	TH1D* D3S2 = new TH1D("D3S2","D3S2",1000,1000,300);
	TH1D* D3S3 = new TH1D("D3S3","D3S3",1000,1000,300);
	TH1D* D3S4 = new TH1D("D3S4","D3S4",1000,1000,300);

	TH1D* D4S1 = new TH1D("D4S1","D4S1",1000,1000,3000);
	TH1D* D4S2 = new TH1D("D4S2","D4S2",1000,1000,3000);
	TH1D* D4S3 = new TH1D("D4S3","D4S3",1000,1000,3000);
	TH1D* D4S4 = new TH1D("D4S4","D4S4",1000,1000,3000);

	TH1D* D5S1 = new TH1D("D5S1","D5S1",1000,1000,3000);
	TH1D* D5S2 = new TH1D("D5S2","D5S2",1000,1000,3000);
	TH1D* D5S3 = new TH1D("D5S3","D5S3",1000,1000,3000);
	TH1D* D5S4 = new TH1D("D5S4","D5S4",1000,1000,3000);

	TH1D* D6S1 = new TH1D("D6S1","D6S1",1000,1000,3000);
	TH1D* D6S2 = new TH1D("D6S2","D6S2",1000,1000,3000);
	TH1D* D6S3 = new TH1D("D6S3","D6S3",1000,1000,3000);
	TH1D* D6S4 = new TH1D("D6S4","D6S4",1000,1000,3000);

	TH1D* D7S1 = new TH1D("D7S1","D7S1",1000,1000,3000);
	TH1D* D7S2 = new TH1D("D7S2","D7S2",1000,1000,3000);
	TH1D* D7S3 = new TH1D("D7S3","D7S3",1000,1000,3000);
	TH1D* D7S4 = new TH1D("D7S4","D7S4",1000,1000,3000);

	TH1D* D8S1 = new TH1D("D8S1","D8S1",1000,1000,3000);
	TH1D* D8S2 = new TH1D("D8S2","D8S2",1000,1000,3000);
	TH1D* D8S3 = new TH1D("D8S3","D8S3",1000,1000,3000);
	TH1D* D8S4 = new TH1D("D8S4","D8S4",1000,1000,3000);

	TH1D* D9S1 = new TH1D("D9S1","D9S1",1000,1000,3000);
	TH1D* D9S2 = new TH1D("D9S2","D9S2",1000,1000,3000);
	TH1D* D9S3 = new TH1D("D9S3","D9S3",1000,1000,3000);
	TH1D* D9S4 = new TH1D("D9S4","D9S4",1000,1000,3000);

	TH1D* D10S1 = new TH1D("D10S1","D10S1",1000,1000,3000);
	TH1D* D10S2 = new TH1D("D10S2","D10S2",1000,1000,3000);
	TH1D* D10S3 = new TH1D("D10S3","D10S3",1000,1000,3000);
	TH1D* D10S4 = new TH1D("D10S4","D10S4",1000,1000,3000);

	TH1D* D11S1 = new TH1D("D11S1","D11S1",1000,1000,3000);
	TH1D* D11S2 = new TH1D("D11S2","D11S2",1000,1000,3000);
	TH1D* D11S3 = new TH1D("D11S3","D11S3",1000,1000,3000);
	TH1D* D11S4 = new TH1D("D11S4","D11S4",1000,1000,3000);

	TH1D* D12S1 = new TH1D("D12S1","D12S1",1000,1000,3000);
	TH1D* D12S2 = new TH1D("D12S2","D12S2",1000,1000,3000);
	TH1D* D12S3 = new TH1D("D12S3","D12S3",1000,1000,3000);
	TH1D* D12S4 = new TH1D("D12S4","D12S4",1000,1000,3000);
	...
	for(unsigned long long int i=0;i<nEntries;i++)
	{
		...
		for( int l=0;l<BarrelDown_vect_size;l++)
		{
			...
			for(int b =0;b<E_strip_DownB.size();b++)
			{
				...
				if(detID_DownB==1) E_vs_strip->Fill(E_strip_DownB.at(b),E_en_DownB.at(b));
				if(detID_DownB==2) E_vs_strip->Fill(E_strip_DownB.at(b)+4,E_en_DownB.at(b));
				if(detID_DownB==3) E_vs_strip->Fill(E_strip_DownB.at(b)+8,E_en_DownB.at(b));
				if(detID_DownB==4) E_vs_strip->Fill(E_strip_DownB.at(b)+12,E_en_DownB.at(b));
				if(detID_DownB==5) E_vs_strip->Fill(E_strip_DownB.at(b)+16,E_en_DownB.at(b));
				if(detID_DownB==6) E_vs_strip->Fill(E_strip_DownB.at(b)+20,E_en_DownB.at(b));
				if(detID_DownB==7) E_vs_strip->Fill(E_strip_DownB.at(b)+24,E_en_DownB.at(b));
				if(detID_DownB==7) E_vs_strip->Fill(E_strip_DownB.at(b)+28,E_en_DownB.at(b));
				if(detID_DownB==8) E_vs_strip->Fill(E_strip_DownB.at(b)+32,E_en_DownB.at(b));
				if(detID_DownB==10) E_vs_strip->Fill(E_strip_DownB.at(b)+36,E_en_DownB.at(b));
				if(detID_DownB==11) E_vs_strip->Fill(E_strip_DownB.at(b)+40,E_en_DownB.at(b));
				if(detID_DownB==12) E_vs_strip->Fill(E_strip_DownB.at(b)+44,E_en_DownB.at(b));





				if(detID_DownB==1 && E_strip_DownB.at(b)==1) D1S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==2 && E_strip_DownB.at(b)==1) D2S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==3 && E_strip_DownB.at(b)==1) D3S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==4 && E_strip_DownB.at(b)==1) D4S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==5 && E_strip_DownB.at(b)==1) D5S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==6 && E_strip_DownB.at(b)==1) D6S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==1) D7S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==1) D8S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==8 && E_strip_DownB.at(b)==1) D9S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==10 && E_strip_DownB.at(b)==1) D10S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==11 && E_strip_DownB.at(b)==1) D11S1->Fill(E_en_DownB.at(b));
				if(detID_DownB==12 && E_strip_DownB.at(b)==1) D12S1->Fill(E_en_DownB.at(b));

				if(detID_DownB==1 && E_strip_DownB.at(b)==2) D1S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==2 && E_strip_DownB.at(b)==2) D2S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==3 && E_strip_DownB.at(b)==2) D3S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==4 && E_strip_DownB.at(b)==2) D4S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==5 && E_strip_DownB.at(b)==2) D5S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==6 && E_strip_DownB.at(b)==2) D6S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==2) D7S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==2) D8S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==8 && E_strip_DownB.at(b)==2) D9S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==10 && E_strip_DownB.at(b)==2) D10S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==11 && E_strip_DownB.at(b)==2) D11S2->Fill(E_en_DownB.at(b));
				if(detID_DownB==12 && E_strip_DownB.at(b)==2) D12S2->Fill(E_en_DownB.at(b));

				if(detID_DownB==1 && E_strip_DownB.at(b)==3) D1S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==2 && E_strip_DownB.at(b)==3) D2S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==3 && E_strip_DownB.at(b)==3) D3S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==4 && E_strip_DownB.at(b)==3) D4S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==5 && E_strip_DownB.at(b)==3) D5S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==6 && E_strip_DownB.at(b)==3) D6S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==3) D7S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==3) D8S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==8 && E_strip_DownB.at(b)==3) D9S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==10 && E_strip_DownB.at(b)==3) D10S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==11 && E_strip_DownB.at(b)==3) D11S3->Fill(E_en_DownB.at(b));
				if(detID_DownB==12 && E_strip_DownB.at(b)==3) D12S3->Fill(E_en_DownB.at(b));

				if(detID_DownB==1 && E_strip_DownB.at(b)==4) D1S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==2 && E_strip_DownB.at(b)==4) D2S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==3 && E_strip_DownB.at(b)==4) D3S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==4 && E_strip_DownB.at(b)==4) D4S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==5 && E_strip_DownB.at(b)==4) D5S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==6 && E_strip_DownB.at(b)==4) D6S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==4) D7S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==7 && E_strip_DownB.at(b)==4) D8S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==8 && E_strip_DownB.at(b)==4) D9S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==10 && E_strip_DownB.at(b)==4) D10S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==11 && E_strip_DownB.at(b)==4) D11S4->Fill(E_en_DownB.at(b));
				if(detID_DownB==12 && E_strip_DownB.at(b)==4) D12S4->Fill(E_en_DownB.at(b));
			}
