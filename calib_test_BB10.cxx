...
void calib_test_BB10()
{
	...
	ifstream SIDAR_calib_params ("SIDAR_dE_fineEcal.txt");
	...
	ifstream BB10_calib_params ("5_15_18_test11.txt");
	...
	ifstream SX3_calib_params ("5_14_18_test6.txt");
...
*/
	...
	Chain1->Add("/media/harry/GODDESS_ANA1/84Se/cal1/alpha_cal_dE_1.root"); //Downstream? SX3 calibration
	...
	TH2D* E_vs_strip = new TH2D("E_vs_strip" ,"E_vs_strip", 100, 0, 100, 1000, 0, 10);
...
/*
				if(detID_UpB==1) E_vs_strip->Fill(dE_strip_UpB.at(k),energy);
				if(detID_UpB==2) E_vs_strip->Fill(dE_strip_UpB.at(k)+8,energy);
				if(detID_UpB==3) E_vs_strip->Fill(dE_strip_UpB.at(k)+16,energy);
				if(detID_UpB==4) E_vs_strip->Fill(dE_strip_UpB.at(k)+24,energy);
				if(detID_UpB==5) E_vs_strip->Fill(dE_strip_UpB.at(k)+32,energy);
				if(detID_UpB==6) E_vs_strip->Fill(dE_strip_UpB.at(k)+40,energy);
				if(detID_UpB==7) E_vs_strip->Fill(dE_strip_UpB.at(k)+48,energy);
				if(detID_UpB==8) E_vs_strip->Fill(dE_strip_UpB.at(k)+56,energy);
				if(detID_UpB==9) E_vs_strip->Fill(dE_strip_UpB.at(k)+64,energy);
				if(detID_UpB==10) E_vs_strip->Fill(dE_strip_UpB.at(k)+72,energy);
				if(detID_UpB==11) E_vs_strip->Fill(dE_strip_UpB.at(k)+80,energy);
				if(detID_UpB==12) E_vs_strip->Fill(dE_strip_UpB.at(k)+88,energy);
*/
		...
		for( int j=0;j<SIDAR_vect_size;j++)
		{
			...
			for(int k=0;k<E_strip_SIDAR.size();k++)
			{
				...
				//if(detID_SIDAR==1) E_vs_strip->Fill(E_strip_SIDAR.at(k),energy);
				//if(detID_SIDAR==2) E_vs_strip->Fill(E_strip_SIDAR.at(k)+16,energy);
				//if(detID_SIDAR==3) E_vs_strip->Fill(E_strip_SIDAR.at(k)+32,energy);
				//if(detID_SIDAR==4) E_vs_strip->Fill(E_strip_SIDAR.at(k)+48,energy);
				//if(detID_SIDAR==5) E_vs_strip->Fill(E_strip_SIDAR.at(k)+64,energy);
				//if(detID_SIDAR==6) E_vs_strip->Fill(E_strip_SIDAR.at(k)+80,energy);
			}
			...
			for(int k=0;k<dE_strip_SIDAR.size();k++)
			{
				...
				if(detID_SIDAR==1) E_vs_strip->Fill(dE_strip_SIDAR.at(k),energy);
				if(detID_SIDAR==2) E_vs_strip->Fill(dE_strip_SIDAR.at(k)+16,energy);
				if(detID_SIDAR==3) E_vs_strip->Fill(dE_strip_SIDAR.at(k)+32,energy);
				if(detID_SIDAR==4) E_vs_strip->Fill(dE_strip_SIDAR.at(k)+48,energy);
				if(detID_SIDAR==5) E_vs_strip->Fill(dE_strip_SIDAR.at(k)+64,energy);
				if(detID_SIDAR==6) E_vs_strip->Fill(dE_strip_SIDAR.at(k)+80,energy);
